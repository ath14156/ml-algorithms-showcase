...
def run_random_forest_classifier():
    ...
    st.write("""
Random Forest Classification is an ensemble learning algorithm that combines
multiple decision trees to improve classification accuracy and reduce overfitting.
""")
